// для постраничного скроллинга разделов сайта
/*!
 * fullPage 2.6.7
...
(function(c, l) { "function" === typeof define && define.amd ? define(["jquery"], function(k) { return l(k, c, c.document, c.Math) }) : "undefined" !== typeof exports ? module.exports = l(require("jquery"), c, c.document, c.Math) : l(jQuery, c, c.document, c.Math) })("undefined" !== typeof window ? window : this, function(c, l, k, n, H) {
    ...
    c.fn.fullpage = function(d) {
        ...
        function ka() {
            ...
            if (!d.autoScrolling || d.scrollBar) {
                if (!a.hasClass("active")) {
                    ...
                    clearTimeout(Y);
                    Y = setTimeout(function() { V = !1 }, 100)
                }
                d.fitToSection && (clearTimeout(Z), Z = setTimeout(function() { u && (c(".fp-section.active").is(a) && (v = !0), B(a), v = !1) },
                    1E3))
            }
        }

        function la(a) { return a.find(".fp-slides").length ? a.find(".fp-slide.active").find(".fp-scrollable") : a.find(".fp-scrollable") }
        ...
        function ma(a, b) { b = b || 0; var g = c(a).parent(); return b < d.normalScrollElementTouchThreshold && g.is(d.normalScrollElements) ? !0 : b == d.normalScrollElementTouchThreshold ? !1 : ma(g, ++b) }
        ...
        function oa(a, b) { for (var d = 0, c = a.slice(n.max(a.length - b, 1)), e = 0; e < c.length; e++) d += c[e]; return n.ceil(d / b) }
        ...
        function Qa(a) {
            if (d.css3 && d.autoScrolling && !d.scrollBar) sa("translate3d(0px, -" + a.dtop + "px, 0px)", !0), d.scrollingSpeed ? ta = setTimeout(function() { ca(a) }, d.scrollingSpeed) : ca(a);
            else {
                var b = Ra(a);
                c(b.element).animate(b.options,
                    d.scrollingSpeed, d.easing).promise().done(function() { ca(a) })
            }
        }
        ...
        function F(a, b) {
            ...
            d.css3 ? (g = "translate3d(-" + n.round(g.left) + "px, 0px, 0px)", wa(a.find(".fp-slidesContainer"), 0 < d.scrollingSpeed).css(xa(g)), ya = setTimeout(function() { u() }, d.scrollingSpeed, d.easing)) : a.animate({ scrollLeft: n.round(g.left) }, d.scrollingSpeed, d.easing, function() { u() });
        ...
        function za() {
            ...
            } else clearTimeout(ga), ga = setTimeout(function() { e.reBuild(!0) }, 350)
        }
        ...
        function I(a) {
            ...
            e > b ? c.length ? c.css("height", b + "px").parent().css("height", b + "px") : (d.verticalCentered ? a.find(".fp-tableCell").wrapInner('<div class="fp-scrollable" />') :
                a.wrapInner('<div class="fp-scrollable" />'), a.find(".fp-scrollable").slimScroll({ allowPageScroll: !0, height: b + "px", size: "10px", alwaysVisible: !0 })) : Ba(a);
            a.css("overflow", "")
        }
        ...
        function Ca(a) { a.addClass("fp-table").wrapInner('<div class="fp-tableCell" style="height:' + Da(a) + 'px;" />') }
        ...
        function ea(a, b) {
            ...
            a === A || d.hasClass("active") ? Fa(d, b) : B(d, function() { Fa(d, b) })
        }
        ...
        function Ia() { return l.PointerEvent ? { down: "pointerdown", move: "pointermove" } : { down: "MSPointerDown", move: "MSPointerMove" } }
        ...
        function xa(a) { return { "-webkit-transform": a, "-moz-transform": a, "-ms-transform": a, transform: a } }
        ...
        function T(a, b, c) { d[a] = b; "internal" !== c && (G[a] = b) }

        function U(a, b) { console && console[a] && console[a]("fullPage: " + b) }
        var x = c("html, body"),
            p = c("body"),
            e = c.fn.fullpage;
        d = c.extend({
        ...
        c.extend(c.easing, { easeInQuart: function(a, b, c, d, e) { return d * (b /= e) * b * b * b + c } });
        e.setAutoScrolling = function(a, b) {
            T("autoScrolling", a, b);
            var g = c(".fp-section.active");
            d.autoScrolling && !d.scrollBar ? (x.css({ overflow: "hidden", height: "100%" }), e.setRecordHistory(d.recordHistory, "internal"), f.css({ "-ms-touch-action": "none", "touch-action": "none" }), g.length && y(g.position().top)) : (x.css({
                overflow: "visible",
                height: "initial"
            }), e.setRecordHistory(!1, "internal"), f.css({ "-ms-touch-action": "", "touch-action": "" }), y(0), g.length && x.scrollTop(g.position().top))
        };
        e.setRecordHistory = function(a, b) { T("recordHistory", a, b) };
        e.setScrollingSpeed = function(a, b) { T("scrollingSpeed", a, b) };
        e.setFitToSection = function(a, b) { T("fitToSection", a, b) };
        ...
        e.setAllowScrolling = function(a, b) { "undefined" !== typeof b ? (b = b.replace(/ /g, "").split(","), c.each(b, function(b, c) { Ja(a, c, "m") })) : a ? (e.setMouseWheelScrolling(!0), Wa()) : (e.setMouseWheelScrolling(!1), Xa()) };
        e.setKeyboardScrolling = function(a, b) {
            "undefined" !== typeof b ? (b = b.replace(/ /g, "").split(","),
                c.each(b, function(b, c) { Ja(a, c, "k") })) : d.keyboardScrolling = a
        };
        ...
        e.moveTo = function(a, b) { var c = Ea(a); "undefined" !== typeof b ? ea(a, b) : 0 < c.length && B(c) };
        e.moveSlideRight = function() { qa("next") };
        e.moveSlideLeft = function() { qa("prev") };
        ...
        var w = !1,
            ...
            A, da, u = !0,
            C = [],
            z, P, h = { m: { up: !0, down: !0, left: !0, right: !0 } };
        h.k = c.extend(!0, {}, h.m);
        var G = c.extend(!0, {}, d),
            ga, ta, ya, Y, Z, Ka;
        c(this).length && (f.css({ height: "100%", position: "relative" }), f.addClass("fullpage-wrapper"), c("html").addClass("fp-enabled"));
        d.css3 && (d.css3 = Va());
        ...
        r.keyup(function(a) { P = a.ctrlKey });
        c(l).blur(function() { P = !1 });
        f.mousedown(function(a) { 2 == a.which && (Q = a.pageY, f.on("mousemove", Sa)) });
